...
# Install Libs
install :; 
forge install https://github.com/smartcontractkit/ccip lib/ccip --no-commit &&
forge install https://github.com/smartcontractkit/chainlink lib/chainlink --no-commit && 
forge install https://github.com/smartcontractkit/chainlink-local lib/chainlink-local --no-commit && 
forge install https://github.com/foundry-rs/forge-std lib/forge-std --no-commit && 
forge install https://github.com/lib/openzeppelin-contracts lib/openzeppelin-contracts --no-commit
